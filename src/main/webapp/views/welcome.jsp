...
<%--    <img src="../assets/img/Logo.png" alt="Welcome Banner" class="banner-img">--%>
    ...
    <p class="description">Welcome to the IoTBay System <br> Continue here</p>
    <!-- Go to Product Management Page -->
    <a href="<%=request.getContextPath()%>/home"><button class="style1">Go to Product Management</button></a>
    <%
        }
    %>
